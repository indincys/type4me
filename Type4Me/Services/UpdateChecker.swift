...
struct UpdateInfo: Codable, Identifiable {
    ...
    var resolvedDmgURL: URL {
        ...
        return URL(string: "https://github.com/indincys/type4me-cloud/releases/download/v\(version)/Type4Me-v\(version)-cloud.dmg")!
    }
...
final class UpdateChecker {
    ...
    private let url = URL(string: "https://raw.githubusercontent.com/indincys/type4me-cloud/main/updates.json")!
